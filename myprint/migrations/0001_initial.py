    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='myprint.category')),
            ],
        ),
        migrations.CreateModel(
            name='CEO',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_uz', models.CharField(max_length=65, verbose_name='name')),
                ('name_ru', models.CharField(max_length=65, verbose_name='name')),
                ('infotype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='types', to='myprint.infotype')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_uz', models.CharField(max_length=65)),
                ('name_ru', models.CharField(max_length=65)),
